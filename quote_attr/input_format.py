...
class AnnotatorInput:
    ...
    def load_input(self):
        ...
        fpath = os.path.join(self.inp_dirpath, self.fandom_fname + '.txt')
        try:
            ...
            with open(fpath) as f:
                ...
                for line in flines:
                    ...
                    buff["fic_id"]=1
                    buff["chapter_id"]=1
                    buff["para_id"]= para_count
                    buff["text"]=line
                    buff["text_tokenized"]= tokenize(line)
                    para_count +=1
                    fic_data.append(buff)    
                    

            fic_data= pd.DataFrame.from_dict(fic_data)
